...
<body>
    ...
    <ul id="packageSubMenu" class="submenu">
        <li><a href="add-package.php"><i class="fas fa-plus-circle"></i> Add Packages</a></li>
        <li><a href="package.php"><i class="fas fa-box"></i> Manage Packages</a></li>
    </ul>
     </li>
            <li><a href="booking-history.php"><i class="fas fa-box"></i> <span>Booking History</span></a></li>
